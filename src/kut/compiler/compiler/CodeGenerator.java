...
public class CodeGenerator 
{
	...
	{
		this.symbolTable.addGlobalVariable(gvar);
	}
	
	/**
	 * @param varname
	 */
	public String getLabelForGlobalVariables(String varname)
	{
	...
	public void allocateGlobalVariables() throws IOException
	{
		...
		for (String gvarname: gvs) {
			this.printCode(	this.getLabelForGlobalVariables(gvarname) + ": db 0, 0, 0, 0, 0, 0, 0, 0 ; allocate 64bits for each global variables. Initialize with zeros.", 1);
		}
